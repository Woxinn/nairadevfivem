...
Config.StaticContracts = {
  ...
  { id='contract_city_general_1', label='City Market Supply', cargoType='general', pickup='ls_port', delivery='textile_city', deliveryCoords=vector3(430.0, -808.0, 29.5), pickupCoords=vector3(1200.0,-3200.0,5.0), distance=4.6, estimatedTime=8, basePayment=1900, requiredLevel=1, requiredLicense=nil, risk='low', difficulty='easy', deadlineMinutes=14, trailerModel='trailers', truckModels={'phantom','hauler','packer'}, multiStop=false, stops={}, convoy=false },
  { id='contract_sandy_construction_1', label='Sandy Construction Materials', cargoType='general', pickup='ls_port', delivery='sandy_yard', deliveryCoords=vector3(1708.0, 3299.0, 41.1), pickupCoords=vector3(1200.0,-3200.0,5.0), distance=12.7, estimatedTime=16, basePayment=3600, requiredLevel=4, requiredLicense='heavy_cargo', risk='medium', difficulty='normal', deadlineMinutes=22, trailerModel='trailers', truckModels={'phantom','hauler'}, multiStop=false, stops={}, convoy=false },
  { id='contract_paleto_fuel_1', label='Paleto Fuel Refill', cargoType='fuel', pickup='ls_port', delivery='paleto_fuel', deliveryCoords=vector3(174.0, 6605.0, 31.8), pickupCoords=vector3(1200.0,-3200.0,5.0), distance=18.9, estimatedTime=24, basePayment=5200, requiredLevel=8, requiredLicense='fuel_tanker', risk='high', difficulty='hard', deadlineMinutes=30, trailerModel='tanker', truckModels={'phantom','hauler'}, multiStop=false, stops={}, convoy=false }
}
